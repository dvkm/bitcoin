...
{
    const char* pszTimestamp = "Tempura Bot Forever";
    const CScript genesisOutputScript = CScript() << ParseHex("043F02A220F65543A42B7BE2980BD375BC091822152550958EF09A4F2CB490812643417C7D744E3D2B32FACB670E2B31109906BF116EF8F9B14DB67D1C2B1854E6") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1559196429, 134084280, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000000007b5e7e2e39ed2e86e91eeb0df52675a55dd700b6ebde8c8f56a0fc40"));
        assert(genesis.hashMerkleRoot == uint256S("0x969b57279e1c5b39e3adde1bd3abcbf1edfd154a7552444cd632a95cac135861"));
        ...
        // release ASAP to avoid it where possible.
         vSeeds.emplace_back("explorer.shrimptempura.org"); // Pieter Wuille, only supports x1, x5, x9, and xd
